...
import { useBrandSelection } from "~/shared/hooks/use-brand-selection";
...
import {
  BrandSelectionFilters,
  BrandSelectionGrid,
  BrandSelectionPagination,
} from "./components";
import type { Route } from "./+types/brand-selection.page";
...
export default function BrandSelectionPage({
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 animate-in fade-in duration-500">
      ...
      {brands.length > 0 ? (
        <>
          <BrandSelectionGrid brands={brands} />
